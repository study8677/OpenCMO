...
- **Strategic Report**: full scan 後に生成されます。
  - 現在のプロジェクト定位
  - 強みと弱み
  - 競合構造と差別化
  - CMO レベルの提言
  - 前回版からの変化
- **Weekly Report**: 直近 7 日の監視ウィンドウから生成されます。
  - 最重要の 3 変化
  - SEO / GEO / SERP / コミュニティの傾向要約
  - 新しいリスクと良い兆候
  - 市場・競合シグナル
  - 次週の重点
- **二層出力**: すべてのレポートは **Human Readout** と **Agent Brief** の両方で保存されます。
