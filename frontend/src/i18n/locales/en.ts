export const en = {
  ...
  "landing.faqTitle": "Questions teams usually ask first",
  "landing.faq1Question": "Can Google index this site cleanly?",
  "landing.faq1Answer": "Yes. The public site now ships with a real robots.txt, sitemap.xml, canonical metadata, and a content-first landing page designed to be indexed.",
  "landing.faq2Question": "Can AI agents understand what OpenCMO does?",
  "landing.faq2Answer": "Yes. The site now exposes an llms.txt summary and clearer public product language so AI crawlers do not need to infer meaning from an app shell.",
  "landing.faq3Question": "Do I still get the full workspace?",
  "landing.faq3Answer": "Yes. The working application remains available in the workspace route, while the homepage focuses on discoverability and product explanation.",
  "landing.finalTitle": "If your product cannot be understood, it cannot be discovered.",
  "landing.finalSubtitle": "Open the workspace, connect your project, and start improving how your brand appears in search engines, AI assistants, and community conversations.",
