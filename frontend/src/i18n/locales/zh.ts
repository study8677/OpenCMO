...
export const zh: Record<TranslationKey, string> = {
  ...
  "landing.faqTitle": "团队最常先问的几个问题",
  "landing.faq1Question": "Google 现在能更稳定地收录这个站吗？",
  "landing.faq1Answer": "可以。公开站点现在提供真实的 robots.txt、sitemap.xml、canonical 元数据，以及面向收录设计的首页内容。",
  "landing.faq2Question": "AI agent 能更容易理解 OpenCMO 是什么吗？",
  "landing.faq2Answer": "可以。站点现在提供 llms.txt 摘要和更清晰的公开产品文案，AI crawler 不再需要从应用壳里猜测产品含义。",
  "landing.faq3Question": "完整工作台还在吗？",
  "landing.faq3Answer": "还在。实际工作区继续保留在 workspace 路由，首页则专注于被发现、被理解和转化。",
  "landing.finalTitle": "如果产品无法被理解，就很难被发现。",
  "landing.finalSubtitle": "打开工作台，接入你的项目，开始改善品牌在搜索引擎、AI 助手和社区讨论中的出现方式。",
